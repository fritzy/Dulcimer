    ...
    mf.all = function (opts, callback) {
        ...
        if (streamType === 'base') {
            ...
            if (opts.index.substr(-4) === '_int') {
                laststream = dbstreams.createIndexRangeEntryReadStream({db: opts.db, start: -9999999999, end: 999999999, reverse: opts.reverse, index: opts.index, bucket: opts.bucket});
            } else {
