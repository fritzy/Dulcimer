...
module.exports = function (mf) {
    ...
    mf.all = function (opts, callback) {
        ...
        if (streamType === 'base') {
            ...
            laststream = dbstreams.createRangeEntryReadStream(opts.db, mf.joinSep('__index__', opts.prefix, opts.index, opts.indexRange.start), mf.joinSep('__index__', opts.prefix, opts.index, opts.indexRange.end), opts.reverse);
        }
