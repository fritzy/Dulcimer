...
module.exports = function (mf) {
    ...
    mf.extendModel({
        ...
        getForeign: function (field, opts, callback) {
            ...
            opts.foreign = {key: '__main__!' + this.key, field: field};
        ...
        getReverseForeign: function (model, field, opts, callback) {
            ...
            opts.foreign = {key: '__main__!' + this.key, field: field, reverse: true};
            return model.all(opts, opts.cb);
        },
        addForeign: function (field, other, opts, callback) {
            ...
            opts.db.addForeignKey('__main__!' + this.key, field, otherkey, {
                bucket: opts.bucket,
                primaryBucket: [opts.bucket, omodel.options.name],
                secondaryBucket: [opts.bucket, mf.options.name],
            }, opts.cb);
        },
        removeForeign: function (field, other, opts, callback) {
            ...
            opts.primaryBucket = [opts.bucket, mf.name];
            opts.secondaryBucket = [opts.bucket, omodel.definition.name];
