                    ...
                    if (mf.options.foreignkey_fields.length > 0 && depth > 0) {
                        ...
                        function (field, ecb) {
                            ...
                            if (typeof obj[field] === 'string') {
                                ...
                                fmodel.load(obj[field], {db: db, depth: depth - 1, bucket: bucket}, function (err, subresult) {
                                    obj[field] = subresult;
                                    ecb(err);
                                });
                            } else {
                        ...
                        function (field, ecb) {
                            ...
                            if (Array.isArray(obj[field])) {
                                ...
                                function (key, acb) {
                                    ...
                                    fmodel.load(key, {db: db, depth: depth - 1, bucket: bucket}, function (err, subresult) {
